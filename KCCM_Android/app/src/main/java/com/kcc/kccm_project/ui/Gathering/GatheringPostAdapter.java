...
public class GatheringPostAdapter extends RecyclerView.Adapter<GatheringPostAdapter.PostViewHolder> {

    private List<GatheringPost> datas; //게시물 데이터

    public GatheringPostAdapter(List<GatheringPost> datas) {
        this.datas = datas;
    } //생성자
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull PostViewHolder holder, int position) {
        GatheringPost data = datas.get(position); //리스트에 넣어주는 작업 ,포지션 0,1,2,3,4
